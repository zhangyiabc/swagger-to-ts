...
import { sign } from 'src/services/login';

const Login = () => {
  const navigate = useNavigate();
  const [loginForm] = Form.useForm();
  const [signUpForm] = Form.useForm();
  const [sinStatus, setSinStatus] = React.useState<'log-in' | 'sign-up'>('sign-up');
  ...
  const handleSign = () => {
    signUpForm.validateFields().then(async values => {
      await sign({
        ...values,
        status: 1,
      });
      message.success('注册成功');
      setSinStatus('sign-up');
    });
  };
  ...
  return (
    <div className="login-container">
        ...
        <div className="container-forms">
          <div className="container-info">
            <div className="info-item">
              <div className="table">
                <div className="table-cell">
                  <p>有账号吗您?</p>
                  <div className="btn" onClick={() => setSinStatus('sign-up')}>
                    登陆
                  </div>
                </div>
              </div>
            ...
            <div className="info-item">
              <div className="table">
                <div className="table-cell">
                  <p>没账号啊?</p>
                  <div className="btn" onClick={() => setSinStatus('log-in')}>
                    注册
                  </div>
                </div>
              </div>
          ...
          <div className="container-form">
            ...
            <div className="form-item sign-up">
              <div className="table">
                <div className="table-cell form-wrapper">
                  <Form form={signUpForm}>
                    ...
                    <Form.Item name="password">
                      <Input name="sign" placeholder="密码" type="password" />
                    </Form.Item>
                  </Form>
                  <div className="btn" onClick={handleSign}>
                    注册
                  </div>
                </div>
              </div>
      ...
      <a className="box-item" href="https://codepen.io/Anna_Batura/" target="_blank">
